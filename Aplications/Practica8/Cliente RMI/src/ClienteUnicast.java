...
public class ClienteUnicast extends Thread{
    ...
    public ClienteUnicast(database db, softwareDownload frameSoftware){
        ...
        this.db = db;
        System.out.println(ANSI_GREEN+"Cliente Unicast Creado. ");
    }
    
    public void run(){
        //System.out.println("Cliente Unicast Iniciado");
    }
    ...
    public void connectWithServer() {
        ...
        try{
            ...
            showMessageDialog(null, "Ocurrio un problema con el servidor Unicast");
        }
    ...
    public void downloadFile(){
        if(cl != null){
        try {
            System.out.println("Pidiendo archivo: " + db.getFileFound().getPath().toString());
            ...
            while (recibidos < tam){
                ...
                System.out.println("Recibido el " + porciento_recibido + "%");
